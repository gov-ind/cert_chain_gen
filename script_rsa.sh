...
#openssl ca -in intermediate.csr -out intermediate.pem -config root.config -extfile ca.ext -days 730 -startdate 120815080000Z -enddate 120815090000Z
...
#openssl ca -in leaf.csr -out leaf.pem -config intermediate.config -days 365 -startdate 120815080000Z -enddate 120815090000Z
